...
2. Redownload Metavision Studio and recreate the virtual enviroment, steps from their website: https://docs.prophesee.ai/stable/installation/windows.html#sdk-installation. I am using Python 3.9. 
3. You should have files "metavision_env" and "ffmpeg-8.0.1-full_build" when done with 2. placed in Lab aka 195 folder. 
...
6. in docs/metavision, add a file named downloaded_pages which will host 13 readable markdown reference pages from the Prophesee website
7. Open VScode in Lab aka 195 and resume work as usual
8. Do not worry about files in the .gitignore, look in jLab google drive in Event Driven Camera VLC for any documents you may need like "experiment replcation 3.1". 
